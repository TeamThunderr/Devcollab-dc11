            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-8">
                  <button type="button" onClick={() => window.location.href = `${import.meta.env.VITE_API_URL}/auth/google`} className={`flex-1 flex items-center justify-center gap-3 py-3 px-4 rounded-xl font-medium border transition-all duration-300 ${
                    isDark 
                  ...
                  <button type="button" onClick={() => window.location.href = `${import.meta.env.VITE_API_URL}/auth/github`} className={`flex-1 flex items-center justify-center gap-3 py-3 px-4 rounded-xl font-medium border transition-all duration-300 ${
                    isDark 
                      ? "bg-[#111] border-white/10 hover:bg-white/5 hover:border-white/20 text-white" 
                      : "bg-white border-black/10 hover:bg-black/5 hover:border-black/20 text-black shadow-sm"
                  }`}>
